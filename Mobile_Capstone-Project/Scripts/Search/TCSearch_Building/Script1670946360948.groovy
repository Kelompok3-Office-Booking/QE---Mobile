...
Mobile.tap(findTestObject('Object Repository/Search_Location/android.widget.Button (6)'), 0)

Mobile.tap(findTestObject('Object Repository/Search_Location/android.widget.EditText - Type keyword'), 0)

Mobile.setText(findTestObject('Object Repository/Search_Location/android.widget.EditText - Type keyword (1)'), 'growink', 
    0)
