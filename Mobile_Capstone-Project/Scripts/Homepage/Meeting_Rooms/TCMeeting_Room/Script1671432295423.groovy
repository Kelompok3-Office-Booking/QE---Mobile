...
Mobile.tap(findTestObject('Object Repository/Homepage/Meeting_Room/android.view.View'), 0)
...
Mobile.tap(findTestObject('Object Repository/Homepage/Meeting_Room/android.widget.Button'), 0)

Mobile.tap(findTestObject('Object Repository/Homepage/Meeting_Room/android.widget.Button (1)'), 0)

Mobile.tap(findTestObject('Object Repository/Homepage/Meeting_Room/android.widget.EditText - Email'), 0)

Mobile.setText(findTestObject('Object Repository/Homepage/Meeting_Room/android.widget.EditText - Emailexamplegmail.com'), 
    'olivia@gmail.com', 0)

Mobile.tap(findTestObject('Object Repository/Homepage/Meeting_Room/android.widget.EditText - Password'), 0)

Mobile.setText(findTestObject('Object Repository/Homepage/Meeting_Room/android.widget.EditText - Password (1)'), 'olivia123', 
    0)

Mobile.hideKeyboard()

Mobile.tap(findTestObject('Object Repository/Homepage/Meeting_Room/android.widget.Button (2)'), 0)
